...
export const parseMetar = metarString => {
      ...
      case 2:
        ...
        if (match) {
          ...
          metarObject.wind = {
            ...
            speed_kts:
              match[4] === "MPS" ? convert.mpsToKts(match[2]) : match[2],
            speed_mps:
              match[4] === "MPS" ? match[2] : convert.ktsToMps(match[2]),
            gust_kts:
              match[4] === "MPS" ? convert.mpsToKts(match[3]) : match[3],
      ...
      case 6:
        ...
        if (match) {
          ...
          metarObject.humidity_percent =
            privateFunctions.calcHumidity(match[1], match[2]) * 100
          mode = 7
        }
        break
      case 7:
  ...
  metarObject.visibility.miles = String(
    privateFunctions.round(metarObject.visibility.miles, 0.5)
  )
  metarObject.visibility.meters = String(
    privateFunctions.round(metarObject.visibility.meters)
  )
